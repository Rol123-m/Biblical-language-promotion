        ...
        <div className="flex flex-col items-center justify-center max-w-4xl mx-auto">
          <div className="animate-fade-in">
            <span className="inline-block bg-saas-orange/10 text-saas-orange px-4 py-2 rounded-full text-sm font-medium mb-6 border border-saas-orange/20">
              Cursos de Idiomas Bíblicos V.2.0.
            </span>
            
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
              Estudia la Biblia en su  <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Idioma Original</span>
            </h1>
            
            <p className="text-lg md:text-xl mb-8 text-gray-300 max-w-2xl mx-auto">
                Recibe apoyo a lo largo de este emocionante camino. Nuestro equipo de facilitadores está 
                preparado para llevar tus habilidades exegéticas al siguiente nivel. 
                Nuestra plataforma online facilitará tu aprendizaje con herramientas únicas y personalizadas.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button onClick={()=> window.location.href= 'https://forms.gle/Xf33ejpcbGF2rMNg6'} className="bg-saas-orange hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200">
                Inscríbete gratis
            ...
            <div className="mt-10 flex items-center justify-center gap-4">
              ...
              <p className="text-sm text-gray-300">
                <span className="font-semibold text-saas-orange">30+</span> lideres formados con nuestro ministerio
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 animate-fade-in" style={{animationDelay: '0.5s'}}>
            ...
            Estudia con nuestras  <span className="gradient-text">herramientas</span> personalizadas, especialmente disñadas para aprender <span className='gradient-text'>Lenguas Bíblicas</span> 
              ...
              Metodologia integrada, y apoyo continuo. 
                </div>
              </div>
            </div>
          </div>
